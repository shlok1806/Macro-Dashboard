...
if not data.empty:
    ...
    fig.add_trace(go.Scatter(x=fc_ci.index, y=fc_ci['upper'], mode='lines', line=dict(dash='dash'), name='Upper CI'))
    fig.add_trace(go.Scatter(x=fc_ci.index, y=fc_ci['lower'], mode='lines', line=dict(dash='dash'), name='Lower CI'))
